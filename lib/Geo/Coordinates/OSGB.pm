...
#   where:
#
#        켆D   = three-digit integer degrees part of latitude (through -90 ~ -00 ~ +90)
#        켆DD  = four-digit integer degrees part of longitude (through -180 ~ -000 ~ +180)
...
#   where:
#
#        켂AA.AAA = variable-length altitude in meters [m].
#
...
the point of origin is 2캷 and 49캮 (in the OSGB geoid model) which is near
...
C<+4900-00200/> is that all the vertical grid lines are parallel to the 2캷
